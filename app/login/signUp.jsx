      ...
      <View style={{padding:25}}>
          ...
          <View style={{marginTop:25}}>
           ...
           <TouchableOpacity style={styles?.button}
                          ...
                          >
                              <Text style={{ textAlign: 'center', fontSize:18, color:'white' }}>Create Account</Text>
                          </TouchableOpacity>
    
                          <TouchableOpacity style={styles?.buttoncreate}
                              onPress={()=> router.push('login/signin')}
                          >
                              <Text style={{ textAlign: 'center', fontSize:18, color:Colors.PRIMARY }}>Already account? Sign in</Text>
                          </TouchableOpacity>
        </View>
  )
}
